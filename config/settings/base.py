...
LOCAL_APPS = [
    "aslcv2_be.users.apps.UsersConfig",
...
MIGRATION_MODULES = {"sites": "aslcv2_be.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "aslcv2_be.utils.context_processors.settings_context",
            ],
        },
    }
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "aslcv2_be.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "aslcv2_be.users.adapters.SocialAccountAdapter"
